;;; hydra-gud-lldb.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-gud-lldb (:color blue :columns 4)
  "LLDB"
...
(provide 'hydra-gud-lldb)
;;; hydra-gud-lldb.el ends here
;; Local Variables:
