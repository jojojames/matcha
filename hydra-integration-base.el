;;; hydra-integration-base.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defun +hydra-heading-current-file ()
  "Return current file for use with `hydra' heading."
  buffer-file-name)

(defun +hydra-heading-current-directory ()
...
(provide 'hydra-integration-base)
;;; hydra-integration-base.el ends here
;; Local Variables:
