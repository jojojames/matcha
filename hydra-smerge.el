;;; hydra-smerge.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-smerge-mode (:color blue :hint nil)
  "

   Smerge: %(+projectile-hydra-root)
...
(+add-minor-mode-command 'hydra-smerge-mode/body '(smerge-mode))

(provide 'hydra-smerge)
;;; hydra-smerge.el ends here
;; Local Variables:
