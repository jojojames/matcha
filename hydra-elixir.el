...
(defhydra hydra-alchemist-iex (:color blue :hint nil)
  "

    Alchemist IEX: %(+projectile-hydra-root)
...
(defhydra hydra-alchemist-eval (:color blue :hint nil)
  "

    Alchemist Eval: %(+projectile-hydra-root)
...
(defhydra hydra-alchemist-test (:color blue :hint nil)
  "

    Alchemist Test: %(+projectile-hydra-root)
...
(defhydra hydra-alchemist-mix (:color blue :hint nil)
  "
...
(defhydra hydra-alchemist-help (:color blue :hint nil)
  "

    Alchemist Help: %(+projectile-hydra-root)
  ------------------------------------------------------------------------------
...
(defhydra hydra-alchemist-phoenix (:color blue :hint nil)
  "

   Phoenix: %(+projectile-hydra-root)
...
(defhydra hydra-alchemist-mode (:color blue :hint nil)
  "

    Alchemist: %(+projectile-hydra-root)
...
"
  ("p" hydra-alchemist-phoenix/body)
  ("e" hydra-alchemist-eval/body)
  ("t" hydra-alchemist-test/body)
  ("i" hydra-alchemist-iex/body)
  ("m" hydra-alchemist-mix/body)
  ("h" hydra-alchemist-help/body)
