;;; hydra-scheme.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-geiser-insert (:color blue :columns 4)
  "Insert"
...
(defhydra hydra-geiser-eval (:color blue :columns 4)
  "Eval"
...
(defhydra hydra-geiser-navigate (:color blue :columns 4)
  "Navigate"
...
(defhydra hydra-geiser-mode (:color blue :columns 4)
  "Geiser"
...
(defhydra hydra-geiser-help (:color blue :columns 4)
  "Help"
  ("r" geiser-xref-callers "Callers")
  ("R" geiser-xref-callees "Callees")
...
(defhydra hydra-geiser-misc (:color blue :columns 4)
  "Misc"
...
(defhydra hydra-geiser-scheme (:color blue :columns 4)
  "Scheme"
...
(+add-minor-mode-command #'hydra-geiser-scheme/body '(geiser-mode))
(+add-minor-eval-command #'hydra-geiser-eval/body '(geiser-mode))

(provide 'hydra-scheme)
;;; hydra-scheme.el ends here
;; Local Variables:
