;;; hydra-notmuch.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-notmuch-tree-mode (:color blue :columns 4)
  "Tree"
...
(defhydra hydra-notmuch-search-mode (:color blue :columns 4)
  "Search"
...
(defhydra hydra-notmuch-hello-mode (:color blue :columns 4)
  "Hello"
  ("m" hydra-notmuch-common/body "Common Commands"))

(defhydra hydra-notmuch-show-stash-commands (:color blue :columns 4)
  "Show Stash Commands"
...
(defhydra hydra-notmuch-show-part (:color blue :columns 4)
  "Show Part"
...
(+add-mode-command #'hydra-notmuch-hello-mode/body '(notmuch-hello-mode))

(+add-mode-command #'hydra-notmuch-show-mode/body '(notmuch-show-mode))

(+add-mode-command #'hydra-notmuch-tree-mode/body '(notmuch-tree-mode))

(+add-mode-command #'hydra-notmuch-search-mode/body '(notmuch-search-mode))

(provide 'hydra-notmuch)
;;; hydra-notmuch.el ends here
;; Local Variables:
