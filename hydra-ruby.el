;;; hydra-ruby.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-bundler-mode (:color blue :columns 4)
  "Bundler"
  ("o" bundle-open "Open")
...
(+add-mode-command #'hydra-ruby-mode/body '(ruby-mode))
...
(+add-minor-mode-command #'hydra-robe-mode/body '(robe-mode))
...
(+add-minor-mode-command #'hydra-rails-mode/body '(projectile-rails-mode))

(provide 'hydra-ruby)
;;; hydra-ruby.el ends here
;; Local Variables:
