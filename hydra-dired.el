;;; hydra-dired.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-dired-mode (:color blue :hint nil)
  "
...
"
  ...
  ("o" hydra-dired-operate/body)
  ("%" hydra-dired-regexp/body)
  ("i" hydra-dired-immediate/body))

(defhydra hydra-dired-operate (:color blue :hint nil)
  "
...
(defhydra hydra-dired-mark (:color blue :hint nil)
  "
...
(defhydra hydra-dired-regexp (:color blue :hint nil)
  "
...
(defhydra hydra-dired-immediate (:color blue :hint nil)
  "
...
(+add-mode-command #'hydra-dired-mode/body '(dired-mode))
