;;; hydra-web.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-web-mode (:color blue :hint nil)
  "
...
"
  ("d" hydra-web-mode-dom/body)
  ("b" hydra-web-mode-block/body)
  ("a" hydra-web-mode-html-attr/body)
  ("e" hydra-web-mode-html-element/body)
  ("t" hydra-web-mode-html-tag/body)
...
(defhydra hydra-web-mode-dom (:color blue :hint nil)
  "
...
(defhydra hydra-web-mode-block (:color blue :hint nil)
  "
...
(defhydra hydra-web-mode-html-attr (:color blue :hint nil)
  "
...
(defhydra hydra-web-mode-html-element (:color blue :hint nil)
  "
...
(defhydra hydra-web-mode-html-tag (:color blue :hint nil)
  "
...
(+add-major-mode-command #'hydra-web-mode/body '(web-mode))

(provide 'hydra-web)
;;; hydra-web.el ends here
;; Local Variables:
