;;; hydra-elisp.el --- Integration with Hydra. -*- lexical-binding: t -*-
...
(defhydra hydra-emacs-lisp-debug (:color blue :columns 4)
  "Elisp Debug"
...
(defhydra hydra-emacs-lisp-eval (:color blue :columns 4)
  "Elisp Eval"
...
(defhydra hydra-emacs-lisp-mode (:color blue :hint nil)
  "

    Elisp: %s(+projectile-hydra-root)
...
"
  ...
  ("e" hydra-emacs-lisp-eval/body)
  ("d" hydra-emacs-lisp-debug/body))

(+add-major-indent-command 'indent-region-or-buffer
                           '(emacs-lisp-mode lisp-interaction-mode))
(+add-major-debug-command 'hydra-emacs-lisp-debug/body
                          '(emacs-lisp-mode lisp-interaction-mode))
(+add-major-eval-command 'hydra-emacs-lisp-eval/body
                         '(emacs-lisp-mode lisp-interaction-mode))
(+add-major-mode-command 'hydra-emacs-lisp-mode/body
                         '(emacs-lisp-mode lisp-interaction-mode))

(provide 'hydra-elisp)
;;; hydra-elisp.el ends here
;; Local Variables:
